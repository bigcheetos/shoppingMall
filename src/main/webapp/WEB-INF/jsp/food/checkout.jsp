                ...
                <h4>주문자 정보</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>이름<span>*</span></p>
                                         ...
                                         <input type="text" value="${memberInfo.memName}"> 
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                            ...
                            <div class="checkout__input">
                                <p>이메일주소<span>*</span></p>
                                <input type="text" value="${memberInfo.emailId}"> 
                            </div>
                            <div class="checkout__input" >
                                <p>주소<span>*</span><button type="button" onclick="execution_daum_address()">주소찾기</button>
                                </p>
                            ...
                            <div class="col-lg-6">
                        		<div class="checkout__input">
								<p>결제방식<span>*</span></p>						                               
                            	<select id="singleSelectTextDDJS" onchange="singleSelectChangeText()">
							     <option value="0">선택</option>
							     <option value="8">신용카드</option>
							     <option value="5">무통장 입금</option>
							</select><br><br>
							
							<input type="hidden" id="textFieldTextJS" placeholder="get value on option select"><br>
							</div>
														   </div>							    
